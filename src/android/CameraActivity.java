...
package com.cinapsis.nativecamera;
...
public class CameraActivity extends Activity implements SensorEventListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(metrics.widthPixels < metrics.heightPixels){
            ...
            height= (metrics.widthPixels/9) * 16 ;

        } else {

            height= metrics.heightPixels;

            width= (metrics.heightPixels/9) * 16 ;
    ...
    private Camera.Size getBestPreviewSize(int height,
        ...
        for (Camera.Size size : parameters.getSupportedPreviewSizes()) {
            ...
            if(Math.abs(ratio - 1.77f) < ASPECT_TOLERANCE && size.height >= height){
                optimalSize = size;
            }
        }
        return optimalSize;
    ...
    private void initPreview() {
        if (camera != null && previewHolder.getSurface() != null) {
            ...
            int height = preview.getHeight() > preview.getWidth()?preview.getWidth():preview.getHeight();
